...
const InboxModal: React.FC<InboxModalProps> = ({ onClose, initialFilter }) => {
                      ...
                      <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center space-x-3 mb-2">
                            <h3 className="font-semibold text-gray-900 dark:text-white dark:text-white">{task.title}</h3>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-xl max-w-2xl w-full p-6">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white dark:text-white">Task Details</h3>
              <button
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-lg text-gray-900 dark:text-white dark:text-white">{selectedTask.title}</h4>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <h5 className="font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-1">Assigned To</h5>
                  <p className="text-gray-600 dark:text-gray-400">{selectedTask.assignedTo}</p>
                </div>
                <div>
                  <h5 className="font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-1">Created Date</h5>
                  <p className="text-gray-600 dark:text-gray-400">{new Date(selectedTask.createdDate).toLocaleDateString()}</p>
                </div>
                <div>
                  <h5 className="font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-1">Due Date</h5>
