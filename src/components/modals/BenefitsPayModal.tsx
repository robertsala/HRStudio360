    ...
    <>
          ...
          <div className="p-6">
            {activeTab === 'overview' && (
              <div className="space-y-6">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white dark:text-white">Compensation Overview</h3>
                
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-green-50 dark:bg-green-900/20 dark:bg-green-900/20 rounded-lg p-6 border border-green-200 dark:border-green-800">
                    <h4 className="font-semibold text-green-900 dark:text-green-300 mb-2">Annual Salary</h4>
                    <p className="text-3xl font-bold text-green-600 dark:text-green-400">$100,000</p>
                    <p className="text-green-700 dark:text-green-400 text-sm">Base compensation</p>
                  </div>
                  <div className="bg-blue-50 dark:bg-blue-900/20 dark:bg-blue-900/20 rounded-lg p-6 border border-blue-200 dark:border-blue-800">
                    <h4 className="font-semibold text-blue-900 dark:text-blue-300 mb-2">Total Benefits Value</h4>
                    <p className="text-3xl font-bold text-blue-600 dark:text-blue-400">$18,500</p>
                    <p className="text-blue-700 dark:text-blue-400 text-sm">Annual value</p>
                  </div>
                  <div className="bg-purple-50 dark:bg-purple-900/20 dark:bg-purple-900/20 rounded-lg p-6 border border-purple-200 dark:border-purple-800">
                    <h4 className="font-semibold text-purple-900 dark:text-purple-300 mb-2">Total Package</h4>
                    <p className="text-3xl font-bold text-purple-600 dark:text-purple-400">$118,500</p>
                ...
                <div className="bg-white dark:bg-gray-800 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-lg p-6">
                  <h4 className="font-semibold text-gray-900 dark:text-white dark:text-white mb-4">Recent Pay Activity</h4>
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-900 dark:bg-gray-900 rounded-lg">
                      <span className="text-gray-900 dark:text-white dark:text-white">Pay stub available - January 1-15, 2025</span>
                      <span className="text-sm text-gray-500 dark:text-gray-400">Available now</span>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-900 dark:bg-gray-900 rounded-lg">
                      <span className="text-gray-900 dark:text-white dark:text-white">Benefits enrollment confirmed</span>
                      <span className="text-sm text-gray-500 dark:text-gray-400">January 1, 2025</span>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-900 dark:bg-gray-900 rounded-lg">
                      <span className="text-gray-900 dark:text-white dark:text-white">401(k) contribution increased</span>
            ...
            {activeTab === 'paystubs' && (
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white dark:text-white">Pay Statements</h3>
                ...
                <div className="grid gap-4">
                  {mockPayStubs.map((payStub) => {
                    ...
                    return (
                      <div key={payStub.id} className="bg-white dark:bg-gray-800 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-lg p-6">
                        <div className="flex items-center justify-between mb-4">
                          <div>
                            <h4 className="font-semibold text-gray-900 dark:text-white dark:text-white">{payStub.payPeriod}</h4>
                            <p className="text-gray-600 dark:text-gray-400 dark:text-gray-400">Pay Date: {payStub.payDate}</p>
                            <div className="flex items-center space-x-4 mt-2 text-sm">
                              <span className="text-gray-600 dark:text-gray-400 dark:text-gray-400">Gross: <span className="font-medium">${payStub.grossPay.toLocaleString()}</span></span>
                              <span className="text-gray-600 dark:text-gray-400 dark:text-gray-400">Net: <span className="font-medium text-green-600 dark:text-green-400">${payStub.netPay.toLocaleString()}</span></span>
                              <span className="text-gray-600 dark:text-gray-400 dark:text-gray-400">Hours: <span className="font-medium">{payStub.regularHours + payStub.overtimeHours}</span></span>
                            </div>
                          </div>
                          <div className="flex space-x-2">
                            <button
                              onClick={() => setSelectedPayStub(payStub)}
                              className="p-2 text-gray-600 dark:text-gray-400 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                            >
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6">
                  ...
                  <div className="grid gap-4">
                    {mockW2Forms.map((w2) => (
                      <div key={w2.id} className="bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-lg p-4 border">
                        <div className="flex items-center justify-between">
                          <div>
                            <h5 className="font-medium text-gray-900 dark:text-white dark:text-white">Form W-2 - {w2.taxYear}</h5>
            ...
            {activeTab === 'benefits' && (
              <div className="space-y-6">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white dark:text-white">Benefits Enrollment</h3>
                
                <div className="grid gap-6">
                  {mockBenefits.map((benefit) => (
                    <div key={benefit.id} className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center space-x-3 mb-2">
                            <h4 className="text-lg font-semibold text-gray-900 dark:text-white dark:text-white">{benefit.name}</h4>
                            <span className="px-2 py-1 bg-green-100 text-green-800 text-xs rounded-full">
                              {benefit.status}
                            </span>
                          </div>
                          <p className="text-gray-600 dark:text-gray-400 mb-2">{benefit.plan}</p>
                          <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 text-sm mb-3">{benefit.description}</p>
                          <div className="grid grid-cols-2 gap-4 text-sm">
                            <div>
                              <span className="font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300">Coverage:</span>
                            ...
                            <div>
                              <span className="font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300">Your Cost:</span>
                              <p className="text-gray-600 dark:text-gray-400">${benefit.employeeCost}/month</p>
                            </div>
                            <div>
                              <span className="font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300">Company Cost:</span>
            ...
            {activeTab === 'compensation' && (
              <div className="space-y-6">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white dark:text-white">Compensation History</h3>
                ...
                <div className="bg-white dark:bg-gray-800 dark:bg-gray-800 border rounded-lg overflow-hidden">
                  <table className="w-full">
                    ...
                    <tbody className="divide-y divide-gray-200">
                      <tr>
                        <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white dark:text-white">January 1, 2025</td>
                        <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white dark:text-white">$100,000</td>
                        <td className="px-6 py-4 whitespace-nowrap text-green-600">+5.3%</td>
                        <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white dark:text-white">Annual Performance Review</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white dark:text-white">January 1, 2024</td>
                        <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white dark:text-white">$95,000</td>
                        <td className="px-6 py-4 whitespace-nowrap text-green-600">+8.0%</td>
                        <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white dark:text-white">Promotion</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white dark:text-white">June 15, 2023</td>
                        <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white dark:text-white">$88,000</td>
                        <td className="px-6 py-4 whitespace-nowrap text-blue-600">Starting Salary</td>
                        <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white dark:text-white">Initial Hire</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between p-6 border-b">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white dark:text-white">Pay Statement Details</h3>
              <button
            ...
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white dark:text-white mb-3">Pay Period Information</h4>
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white dark:text-white mb-3">Earnings</h4>
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between border-t pt-2">
                      <span className="font-medium text-gray-900 dark:text-white dark:text-white">Gross Pay:</span>
              ...
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-white dark:text-white mb-3">Deductions</h4>
                <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div className="border-t pt-4 mt-4">
                  <div className="flex justify-between">
                    <span className="font-bold text-gray-900 dark:text-white dark:text-white">Net Pay:</span>
                    <span className="font-bold text-green-600 text-lg">${selectedPayStub.netPay.toFixed(2)}</span>
                  </div>
                </div>
              </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-xl max-w-2xl w-full p-6">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white dark:text-white">W-2 Form Details</h3>
              <button
      ...
      {selectedBenefit && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-xl max-w-2xl w-full p-6">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white dark:text-white">Benefit Details</h3>
              <button
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-white dark:text-white">{selectedBenefit.name}</h4>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  <span className="font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300">Status:</span>
                  <p className="text-gray-600 dark:text-gray-400">{selectedBenefit.status}</p>
                </div>
                <div>
                  <span className="font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300">Your Monthly Cost:</span>
                  <p className="text-gray-600 dark:text-gray-400">${selectedBenefit.employeeCost}</p>
                </div>
                <div>
                  <span className="font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300">Company Contribution:</span>
                  <p className="text-gray-600 dark:text-gray-400">${selectedBenefit.employerCost}</p>
                </div>
              </div>
              <div>
                <span className="font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300">Description:</span>
      ...
      {showModifyEnrollment && selectedBenefit && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-60 p-4">
          <div className="bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-xl max-w-2xl w-full p-6">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white dark:text-white">Modify Enrollment - {selectedBenefit.name}</h3>
              <button
            ...
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">Coverage Level</label>
                <select className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">Effective Date</label>
                <input
                  type="date"
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-blue-800">Your Monthly Cost:</span>
                    <span className="font-medium text-blue-900">${selectedBenefit.employeeCost}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-blue-800">Company Contribution:</span>
                    <span className="font-medium text-blue-900">${selectedBenefit.employerCost}</span>
                  </div>
                  <div className="flex justify-between border-t border-blue-200 pt-2">
                    <span className="font-semibold text-blue-900">Total Value:</span>
                    <span className="font-bold text-blue-900">${selectedBenefit.employeeCost + selectedBenefit.employerCost}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-end space-x-3 mt-6">
              ...
              <button
                onClick={() => {
                  ...
                  setNotification({
                    type: 'success',
                    message: `${selectedBenefit.name} enrollment has been modified successfully!`
                  });
                  setTimeout(() => setNotification(null), 3000);
                }}
                className="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors"
...
export default BenefitsPayModal;