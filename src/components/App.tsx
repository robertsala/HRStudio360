    ...
    >
      <div className="bg-white rounded-xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
                  ...
                  <div className="relative">
                    ...
                    <div className="flex">
                      <select
                        ...
                        className="flex-1 pl-10 pr-4 py-2 border border-gray-300 rounded-l-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        required
                      >
                ...
                <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-gray-900">{formData.startDate ? new Date(formData.startDate).toLocaleDateString() : ''}</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-700">Salary</p>
                      <p className="text-gray-900">{formData.salary ? `$${parseInt(formData.salary).toLocaleString()}` : ''}</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {showAddJobTitle && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-60 p-4">
            <div className="bg-white rounded-xl max-w-md w-full p-6">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Add New Job Title</h3>
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Job Title</label>
                  <input
